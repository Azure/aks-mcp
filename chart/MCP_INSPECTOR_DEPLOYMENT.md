...
helm upgrade --install aks-mcp-inspector . \
  --namespace aks-mcp-mcp-inspector \
  --create-namespace \
...
```bash
# Check pod status
kubectl get pods -n aks-mcp-mcp-inspector

# Check service
kubectl get svc -n aks-mcp-mcp-inspector

# View logs
kubectl logs -f deployment/aks-mcp-inspector -n aks-mcp-mcp-inspector
```
...
kubectl port-forward service/aks-mcp-inspector 8081:8081 -n aks-mcp-mcp-inspector
```
...
kubectl port-forward deployment/aks-mcp-inspector 8081:8081 -n aks-mcp-mcp-inspector

# Or port-forward to a specific pod
kubectl port-forward pod/<pod-name> 8081:8081 -n aks-mcp-mcp-inspector
```
...
3. **Develop and Test**:
   ...
   - Monitor AKS-MCP logs: `kubectl logs -f deployment/aks-mcp-inspector -n aks-mcp-mcp-inspector`
...
helm uninstall aks-mcp-inspector -n aks-mcp-mcp-inspector

# Remove the namespace
kubectl delete namespace aks-mcp-mcp-inspector
